...
def testing_all_models(models_dir, test_loader, results_file):
    ...
    for model in models_list:
        ...
        MuAc_model = torch.load(os.path.join(models_dir,model))
...
MuAc_testset = Dataset(root_dir, transform = preprocess)

# Dataloader
test_loader = DataLoader(MuAc_testset, batch_size = 32, shuffle = False)
